      ...
      <div class="container">
        <div class="row">
            <div class="col-md-8">
                ...
                <?php
                    $sql1="SELECT * FROM category WHERE category_id={$cat_id}" or die("query isfailed");
                   ...
                   <!-- there is pagination code -->
                    <?php
                     ...
                     if (mysqli_num_rows($result1)) {
                       ...
                       if ($page > 1) {
                         echo '<li><a href="category.php?cid='.$cat_id.'&cat='.$cat.'&page='.($page - 1).'">Prev</a></li>';
                       }
                       ...
                       for ($i=1; $i <= $total_page ; $i++) { 
                        ...
                        echo '<li class="'.$active.'" ><a href="category.php?cid='.$cat_id.'&cat='.$cat.'&page='.$i.'">'.$i.'</a></li>';
                       }
                       // condition for next button showing
                       if ($total_page > $page) {
                         echo '<li><a href="category.php?cid='.$cat_id.'&cat='.$cat.'&page='.($page + 1).'">Next</a></li>';
                       }
                       echo '</ul>';
                     }
                    ?>
